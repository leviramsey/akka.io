...
When migrating an existing project from Akka 2.2.3 please have a look at the [migration guide](https://doc.akka.io/docs/akka/2.3/project/migration-guide-2.2.x-2.3.x.html)
