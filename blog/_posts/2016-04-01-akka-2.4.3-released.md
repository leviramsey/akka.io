...
* new search engine (powered by algolia) for our [docs](https://doc.akka.io/docs/akka/current/?language=scala) - which should make navigating the documentation much more pleasant
